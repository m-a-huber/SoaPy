...
def number_to_neg_cont_frac(p,q):
     ...
     Returns:
         list[int]: The coefficients of the (-)-continued fraction expansion of a rational number p/q.
     """     
     L = []
...
def number_from_neg_cont_frac(*args):
     ...
     Returns:
         sym.Rational: The rational number p/q with corresponding coefficients in its (-)-continued fraction decomposition.
     """     
     x = args[-1]
     for i in args[-2::-1]:
