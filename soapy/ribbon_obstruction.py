...
def ribbon_obstruction_corr(L, M):
    """This checks whether a pair of 3-manifolds with given lists of
    correction terms passes the d-invariant obstruction to the existence of a
    ribbon cobordism between them.
...
def ribbon_obstruction_sfs(C_1, C_2):
    """This checks whether a pair of Seifert fibered spaces passes the
    d-invariant obstruction to the existence of a ribbon cobordism between
    them.

    Args:
        C_1 (list[int]): List of coefficients specifying the first Seifert
            fibered space.
        C_2 (list[int]): List of coefficients specifying the second Seifert
            fibered space.
...
def ribbon_obstruction_lens(p, q, r, s):
    """This checks whether a pair of lens spaces passes the d-invariant
    obstruction to the existence of a ribbon cobordism between them.
...
def ribbon_obstruction_prism(p, q, r, s):
    """This checks whether a pair of prism manifolds passes the d-invariant
    obstruction to the existence of a ribbon cobordism between them.
